...
| R5 | Comprehensive animation update: modern motion, WebGL shaders and equivalents on other platforms, Resin moving like a fluid | in progress — tasks 17–20 |
...
| R10 | Research Neumorphism to inform how Haze should look and feel — shadows, feathering, light source — especially filling a Resin frame | in progress |
| R11 | **Resin-on-Resin is prohibited.** A layer above a Resin element, such as a label, must be a Haze content fill. Do not adjust Resin to compensate: that would disturb the material spec. | in progress |
