...
The [approved Crystal material studies](reference/approved-crystal/README.md) are the visual standard for all future work. Unexplained divergence is a defect. See [project guidelines](AGENTS.md).
